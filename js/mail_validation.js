...
$mjq(function(){
	...
	$mjq("#inputNombre").bind('blur', is_valid_name);
        $mjq("#inputArea").bind('blur', is_valid_area);
        ...
        $mjq.ajax({
            ...
            success: function(data) {
                ...
                $mjq('#inputArea option:eq(0)').attr('selected','selected');
                //}
...
function is_valid_form() {
	...
	if (!is_valid_email()) var ret = false;
        if (!is_valid_area()) var ret = false;
