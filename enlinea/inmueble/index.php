...
//                ));
        ...
        echo $twig->render(
            'condominio/junta-condominio.html.twig', 
            array(
                "session" => $session,
                "junta" => $miembros
            )
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="carta-residencia">
    case "carta-residencia":
        ...
        echo $twig->render('condominio/carta-residencia.html.twig', 
            array(
            "session" => $session,
    ...
    // <editor-fold defaultstate="collapsed" desc="carta de residencia">
    case "imprimir-carta-residencia":
        $inmueble = '0001';
        $modelo_carta = "../carta-residencia-" . $inmueble . ".html";
