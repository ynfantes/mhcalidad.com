...
Class Misc {
    ...
    /**
     * Elimina vocales con acento y 
     * algunos caracteres especiales de un string dado
    ...
    public static function error_handler($num, $err, $file, $line) {
        ...
        $headers .= 'From: MH Calidad Administrativa Daemon <info@mhcalidadadministrativa.com>' . "\r\n";
        $html = "";
...
//     var $key = 'AIzaSyDxLyTpE-oh_Pz3vSHVsrOUdPpIGvXitEA';
