...
class factura extends db implements crud {
    ...
    public function facturaPerteneceACliente($factura,$cedula) {
        ...
        $query = "select propiedades.* from propiedades join 
                historico_avisos_cobro on historico_avisos_cobro.apto = propiedades.apto and 
                historico_avisos_cobro.id_inmueble = propiedades.id_inmueble 
                where historico_avisos_cobro.numero_factura='".$factura."'";
    ...
    public static function historicoAvisosDeCobro($inmueble,$propietario,$año=null){
        $sql = "select * from historico_avisos_cobro where id_inmueble='$inmueble' and apto='$propietario' ";
        if ($año!=null) {
